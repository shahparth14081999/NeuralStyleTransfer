...
def generate_noise_image(content_image, noise_ratio = CONFIG.NOISE_RATIO):
    ...
    noise_image = np.random.uniform(content_image.mean()-content_image.std(),content_image.mean()+content_image.std() , (1, CONFIG.IMAGE_HEIGHT, CONFIG.IMAGE_WIDTH, CONFIG.COLOR_CHANNELS)).astype('float32')
